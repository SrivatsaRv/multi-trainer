...
def read_user_me(
    ...
    # Note: SQLModel doesn't always play nice with Pydantic response models for relationships 
    # if not explicitly defined in a Read schema.
    # For MVP, returning a custom dict is safer/faster than debugging Pydantic recursion.
