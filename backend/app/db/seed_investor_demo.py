    ...
    with Session(engine) as session:
        ...
        if not gym:
            ...
            gym = Gym(
                ...
                description=(
                    "The ultimate destination for serious hypertrophy and strength "
                    "training. Old school iron, new school science."
                ),
                photos=[
            ...
            session.add(gym)
            session.commit()
            print("✅ Created Gym: Iron Titan Fitness")
        ...
        if not gym:
            gym = Gym(
                ...
                description=(
                    "Find your center in the chaos of the city. "
                    "Premium yoga and pilates studio."
                ),
                photos=[
            ...
            session.add(gym)
            session.commit()
            print("✅ Created Gym: Urban Pulse Yoga")
        ...
        if not gym:
            gym = Gym(
                ...
                description=(
                    "Elite performance center for athletes. CrossFit "
                    "affiliation pending."
                ),
                photos=[
                    "https://images.unsplash.com/photo-1517963879466-cd11fa9e60de?"
                    "auto=format&fit=crop"
                ],
            ...
            session.add(gym)
            session.commit()
            print("✅ Created Gym: Zenith Performance")
